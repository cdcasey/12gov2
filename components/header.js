...
export default function Header() {
  return (
    <header className="mb-20 text-center text-otgopurple-dark relative object-cover h-cover md:h-covermd lg:h-coverlg overflow-hidden">
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2  hover:text-otgoorange-light duration-200 transition-colors bg-white shadow-otgo z-10">
